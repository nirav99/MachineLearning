...
J = -1 * logicalY .* log(p2) - (1 - logicalY) .* log(1 - p2);
...
for i = 1:m
  ...
  % Note that y(i, :) is a collection of actual labels (1 through 10).
  % We need to convert it to logical array where only one element is 1 that matches the current training example
  yLogical = 1:num_labels;
  delta3 = a3 - [yLogical == y(i)];
