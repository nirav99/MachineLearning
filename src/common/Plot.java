...
public class Plot
{
  ...
  private String gnuplotPath = "/Applications/Gnuplot.app/Contents/Resources/bin/gnuplot";
  ...
  private static PlotStyle style = PlotStyle.POINTS;
  private static PlotStyle style2 = PlotStyle.POINTS;
  ...
  public static void setPlotStyle(PlotStyle ps1, PlotStyle ps2)
  {
    style = ps1;
    style2 = ps2;
  }
  ...
  { 
    ...
    if(y2Data == null)
    {
      writer.write("plot \"" + dataFile + "\" using 1:2 title \'" + series1 +
                   "\' with " + getPlotStyle(style));
    }
    else
    {
      writer.write("plot \"" + dataFile + "\" using 1:2 title \'" + series1 + 
                   "\'  with " + getPlotStyle(style) + ", \"" + dataFile + "\" using 1:3 title \'" + 
                   series2 + "\' with " + getPlotStyle(style2));
    }
    writer.newLine();
    writer.close();
  }

  private String getPlotStyle(PlotStyle pStyle)
  {
    if(pStyle == PlotStyle.BAR)
      return "boxes";
    if(pStyle == PlotStyle.LINE)
      return "lines";
    if(pStyle == PlotStyle.POINTS)
      return "points";
    return "";
  }
